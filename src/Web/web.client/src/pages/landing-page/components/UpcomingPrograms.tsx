...
const items = [
    {
        icon: <SportsHockeyRounded />,
        title: "Spring Hockey",
        description:
            "This item could provide a snapshot of the most important metrics or data points related to the product.",
        imageLight: 'url("/static/images/spring-clinics.png")',
        imageDark: 'url("/static/images/spring-clinics.png")',
    },
    {
                ...
                <Grid item xs={12} md={6}>
                    <div>
                        ...
                        <Typography variant="body1" color="text.secondary" sx={{ mb: { xs: 2, sm: 4 } }}>
                            Create an account to register for upcoming events!
                        </Typography>
                    </div>
